...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f'reports/logs/mscnn_training_{timestamp}.log'),
...
def main():
    ...
    for fold, (train_idx, val_idx) in enumerate(kfold.split(dataset)):
        ...
        # Create data loaders for this fold with optimized settings
        ...
        plot_training_results(
            ...
            fold, timestamp, model_name='mscnn'
        )
    ...
    plot_all_folds_results(all_fold_results, timestamp, model_name='mscnn')
